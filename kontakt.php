...
<input type="submit" class="btn btn-info" value="Trazi">
		...
		<div class="row">
			<div class="col-sm-12 col-md-9 sadrzaj">
				<h1>Kontakt</h1>
				<h2><span class="glyphicon glyphicon-user"></span>Nemanja Ilic</h2>
				<h4><span class="glyphicon glyphicon-education"></span>Br. indeksa: S33/14</h4>
				<h5><span class="glyphicon glyphicon-envelope"></span>nilic14@raf.edu.rs</h5><br>	
